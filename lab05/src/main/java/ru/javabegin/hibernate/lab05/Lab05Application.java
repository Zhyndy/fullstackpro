...
import ru.javabegin.hibernate.lab05.domain.*;

@SpringBootApplication
public class Lab05Application implements CommandLineRunner {
    private static final Logger logger = LoggerFactory.getLogger(Lab05Application.class);
    private final CarRepository repository;
    private final OwnerRepository orepository;
    private final AppUserRepository urepository;

    public Lab05Application(CarRepository repository, OwnerRepository orepository,
